...
The repository includes synthetic parity tests (under
``tests/parity/``) that pin xpcsjax's engine behaviour against
committed baselines. Any change in xpcsjax that breaks parity is a
