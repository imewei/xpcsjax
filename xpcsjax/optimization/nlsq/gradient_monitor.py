...
class GradientCollapseMonitor:
    ...
    def get_diagnostics(self) -> dict:
        ...
        diag = {
            ...
            "min_physical_grad": float(np.nanmin(physical_norms)),
            "max_physical_grad": float(np.nanmax(physical_norms)),
...
def gradient_monitor_diagnostics(monitor, *, mechanism="per_iteration_gradient_ratio"):
    ...
    return {
        ...
        "min_gradient_ratio": float(np.nanmin(ratios)) if ratios else float("nan"),
        "max_gradient_ratio": float(np.nanmax(ratios)) if ratios else float("nan"),
