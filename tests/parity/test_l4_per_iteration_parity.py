...
# laminar_flow solve must leave the result BIT-IDENTICAL. The monitor is
# strictly observational.
#
# The load-bearing, dependency-free guard is ``test_homodyne_l4_is_diagnostic_only``
# below — it runs unconditionally and asserts monitor-ON == monitor-OFF (bit-
# identical popt + chi2), the observational property.
# ---------------------------------------------------------------------------
